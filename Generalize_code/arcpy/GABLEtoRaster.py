...
class GABLE:
    ...
    def clip_by_fishnet(self, fileroot=None, fishnet_json=None, clip_root=None):
        ...
        with open(fishnet_json, 'r') as fishnet:
            ...
            for ii in range(90, len(self.filepaths)):
                filepath = self.filepaths[ii]
                filename = self.filenames[ii]
...
if __name__ == '__main__':
    ...
    # G.to_wgs84_all()
    G.generate_all_fishnet(fishnet_root=r'G:\ProductData\GABLE_fishnet_0p5', fishnet_file="ChinaFishNet_0p5.json")
    G.clip_by_fishnet(fishnet_json="ChinaFishNet_0p5.json", clip_root=r'G:\ProductData\GABLE_CLIP')
