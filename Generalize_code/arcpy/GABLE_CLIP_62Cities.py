...
if __name__ == '__main__':
    ...
    # BF_root = r'G:\ProductData\East_Asian_buildings\China'
    # save_root = make_dir(r'G:\ProductData\East_Asian_buildings\61cities')
    # projected_root = make_dir(r'G:\ProductData\East_Asian_buildings\61cities_originfiles')
    # for province in BF_city_dict.keys():
    #     assert os.path.exists(r'{}\{}'.format(BF_root, province)), province
    ...
    #         #     save_path = os.path.join(projected_root, city+'.shp')
    #         #     print u"Projecting  " + city
    #         #     if os.path.isfile(save_path):
    #         #         continue
    #         #     arcpy.Project_management(tar_file, save_path, BF_project)
    #         #
    #         # else:
    #         #     if os.path.isfile(os.path.join(projected_root, city+'.shp')):
    #         #         continue
    #         #     for suffix in ['.dbf', '.prj', '.shp', '.shp.xml', '.shx', '.sbn', '.sbx']:
    #         #         from_file = tar_file.replace('.shp', suffix)
    #         #         print from_file, projected_root
    #         #         if os.path.isfile(from_file):
    #         #             mycopyfile(from_file, projected_root)
    #
    #         tar_file_ = r'{}\{}.shp'.format(projected_root, city)
    #         print u"CLIPPING  " + clip_file
    #         save_path = os.path.join(save_root, city + ".shp")
    #         if os.path.isfile(save_path):
    #             continue
    #         print clip_file, tar_file_, save_path
