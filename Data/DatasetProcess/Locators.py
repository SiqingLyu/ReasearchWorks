    ...
    def locate_image(self):
        ...
        if (latitude_index_rb != latitude_index_lt) | (longitude_index_rb != longitude_index_lt):
            ...
            if latitude_index_rb == latitude_index_lt:  # 右上角
                ...
                """
                image_name.append(os.path.join(self.root, 'CBRA_{}'.format(self.year),
                                              'CBRA_{}_E{}_N{}.tif'.format(self.year, image_name_lon_rt, image_name_lat_rt)))
                image_name.append('')  # 3
                image_name.append('')  # 4
                ...
                image_name.append('')  # 2
                image_name.append(os.path.join(self.root, 'CBRA_{}'.format(self.year),
                                              'CBRA_{}_E{}_N{}.tif'.format(self.year, image_name_lon_lb, image_name_lat_lb)))
                image_name.append('')  # 4
                ...
                image_name.append(os.path.join(self.root, 'CBRA_{}'.format(self.year),
                                              'CBRA_{}_E{}_N{}.tif'.format(self.year, image_name_lon_lb, image_name_lat_lb)))
                image_name.append(os.path.join(self.root, 'CBRA_{}'.format(self.year),
                                              'CBRA_{}_E{}_N{}.tif'.format(self.year, image_name_lon_rb, image_name_lat_rb)))
